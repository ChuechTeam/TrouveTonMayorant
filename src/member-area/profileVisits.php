...
<h1 class="title">Statistiques de votre profil</h1>
<div id="stats">
    <div class="-stat">
    ...
    <div class="-stat">
        <div class="-bg-equation has-math -wait-mathjax">$$ \frac{100}{n} \sum_{i=1}^n \delta_{g_i}^{\mathrm{homme}} $$</div>
        <h2 class="-title">Pourcentage d'hommes</h2>
        <div class="-value"><?= $mProp ?>%</div>
    </div>
    <div class="-stat">
        <div class="-bg-equation has-math -wait-mathjax">$$ \frac{100}{n} \sum_{i=1}^n \delta_{g_i}^{\mathrm{femme}} $$</div>
